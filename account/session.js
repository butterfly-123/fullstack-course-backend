...
class Session {
    ...
    static verify(sessionString) {
        ...
        console.log('Session.parse(sessionString)', Session.parse(sessionString));
...
const takeFooString = `admin_${fooString}`;
console.log('Session.verify(takeFooString)', Session.verify(takeFooString));
